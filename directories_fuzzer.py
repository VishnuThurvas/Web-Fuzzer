...
def fuzz_directories(target_url, wordlist="wordlists/directories.txt"):
    ...
    report_file = "reports/directories_report.txt"  # Report file path
    ...
    try:
        ...
        plt.ylabel("Count")
        plt.title("Directory Fuzzing Status Code Distribution")
        plt.xticks(rotation=45)
        plt.grid(axis='y', linestyle='--', alpha=0.7)
        plt.savefig("reports/directories_status_chart.png")
        plt.close()

        print("[*] Graphical report saved to reports/directories_status_chart.png")
